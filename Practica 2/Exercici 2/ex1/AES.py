...
def main():
    ...
    #key = 0x4534649229346934E6CD395BBD2F21CF
    #i = 128
    #print(key.to_bytes(16, byteorder='big', signed=True))
    k = key.to_bytes(16, byteorder='big', signed=True)
    encryptedFile = encrypt(k, originalFile)
    open('encriptat', 'wb').write(encryptedFile)
    #decryptedFile = decrypt(k, encryptedFile)
    #open('desencriptat', 'wb').write(decryptedFile)
