...
def canviabits(num, index1, index2):
    numBinari = format(num,'08b')
    b1 = numBinari[index1]
    if (b1 == "0"):
        b1 = "1"
...
def exercici():
    ...
    for l in range(10):
        ...
        for i in range(4):
            for j in range(4):
                originalValue_i = missatgeBloc[i][j]
                for k in range(8):
                    for ii in range(4):
                        for jj in range(4):
                            originalValue_j = missatgeBloc[ii][jj]
                            for kk in range(8):
                                if k == kk and i == ii and j == jj:
                                    # si es el mateix bit
                                    ...
                                    if i == ii and j == jj:
                                        ...
                                        numj = canviabit(missatgeBloc[ii][jj],kk)
                                        numij = canviabits(missatgeBloc[i][j],k,kk)
